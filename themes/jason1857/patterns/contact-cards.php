...
<!-- wp:group {"className":"contact-card-body","layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group contact-card-body"><!-- wp:paragraph {"className":"contact-card-text"} -->
